 ...
 * Created for: ICS4U
 * Day #22 (Inheritance)
 * This program ... Inherits from the vehicle class and creates bikes and trucks
*/

import java.util.*;
public class Day22_Inheritance {
	// Variables.
	static int bikeID = 1;
...
class Bike extends Vehicle {
	Bike(String color, int numWheels, int numSeats, int cSpeed, int sMax, int id) {			
		...
		String outTemp = String.format("Bike #%d : ", id) + "\n"
				+ "Bike Colour : " + vehicleColor + "\n"
				+ "Number of wheels : " + wheels + "\n"
				+ "Number of seats : " + seats + "\n"
				+ "Current Speed : " + currentSpeed + "\n"
				+ "Max Speed : " + maxSpeed + "\n\n";
		Day22_Inheritance.out.add(outTemp);
	}
}
...
class Truck extends Vehicle {
	Truck(String lP, String c, int numD, int numW, int len,int cSpeed, int sMax, int id) {			
		...
		String outTemp = String.format("Truck #%d : ", id) + "\n"
