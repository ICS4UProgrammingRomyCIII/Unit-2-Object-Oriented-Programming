 ...
 * This program ... The vehicle class is now abstract (Can only be inherited from and not instantiated).
*/

import java.util.*;
public class Day24_Abstraction {
	// Variables.
	static int bikeID = 1;
...
class Bike extends Vehicle {
	...
	public void FillVehicleInfo(int bikeID) {
		String outTemp = String.format("Bike #%d : ", bikeID) + "\n"
				...
				+ "Max Speed : " + maxSpeed + "\n\n";
		Day24_Abstraction.out.add(outTemp);
	}
}
